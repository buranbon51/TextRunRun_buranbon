...
; 設定
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(24, 27, 465, 485, 505)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(25, 36, 530, 560, 590)
tmpNumStartY := cen_anyOfNumFromDpiAndFontSize(2, 4, 50, 55, 60)

fontNum2 := cen_fontNumFromDpiAndFontSize(11, 9, 7)
tmpNumW := cen_anyOfNumFromDpiAndFontSize(1, 4, 50, 60, 70)
...
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(20, 23, 350, 370, 390)
Gui, 74:Add, Text,   X60 y+5 , 実行する処理(&1)
Gui, 74:Add, Edit,   X60 y+5 w%tmpNumW2%  vEdit74_4
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(22, 26, 400, 420, 440)
...
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(18, 27, 430, 450, 470)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(11, 22, 340, 360, 380)
...
Gui, 74:Tab, 3
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(8, 6, 130, 135, 140)
...
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(11, 8, 175, 180, 185)
...
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(20, 25, 410, 430, 450)
