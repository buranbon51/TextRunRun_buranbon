...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(13, 27, 350, 320, 290)
tmpNumH := cen_anyOfNumFromDpiAndFontSize(36, 36, 580, 510, 440)
...
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(16, 21, 290, 270, 250)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(8, 10, 110, 100, 90)
...
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(16, 26, 320, 290, 260)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(5, 5, 90, 90, 90)
tmpNumW := cen_anyOfNumFromDpiAndFontSize(9, 12, 190, 170, 150)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(16, 20, 230, 230, 230)
Gui, 72:Add, Edit, X10 y+5   w%tmpNumW% vEdit72_2_1   gSubEdit72_2_1
tmpNumW := cen_anyOfNumFromDpiAndFontSize(2, 4, 60, 60, 60)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(26, 32, 450, 410, 370)
tmpNumH := cen_anyOfNumFromDpiAndFontSize(36, 36, 550, 470, 390)

tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(14, 18, 200, 180, 160)
...
Gui, 73:Add, Text,    xp+0 y+20 w200 c36A2FF vText73_1_2
...
Gui, 73:Add, Text,    xp+0 y+20 w200 c36A2FF vText73_2_2
...
Gui, 73:Add, Text,    xp+0 y+20 w200 c36A2FF vText73_3_2
...
Gui, 73:Add, Text,    xp+0 y+20 w200 c36A2FF vText73_7_2
...
fontNum := cen_fontNumFromDpiAndFontSize(14, 10, 8)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(19, 23, 320, 300, 280)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(12, 27, 350, 320, 290)
tmpNumH := cen_anyOfNumFromDpiAndFontSize(32, 32, 580, 550, 520)
...
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(17, 21, 290, 260, 230)
...
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(2, 4, 60, 60, 60)
...
; 最後の文字によって、自動的に実行する。
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(36, 38, 610, 480, 350)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(17, 23, 600, 510, 400)
tmpNumStartY := cen_anyOfNumFromDpiAndFontSize(2, 4, 50, 50, 50)

tmpNumW := cen_anyOfNumFromDpiAndFontSize(8, 10, 120, 100, 80)
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(16, 20, 350, 300, 250)
...
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(4, 8, 90, 90, 90)
...
fontNum := cen_fontNumFromDpiAndFontSize(12, 9, 7)
fontNum2 := cen_fontNumFromDpiAndFontSize(10, 8, 7)
...
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(20, 25, 420, 390, 360)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(12, 10, 240, 220, 200)
Gui, 85:Add, GroupBox, X10 y+10  w%tmpNumGroupW% h%tmpNumGroupH%
Gui, 85:Add, Text,      X30 yp+15 , ソフト全体のフォントのサイズ(&S)
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(9, 12, 130, 130, 130)
...
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(8, 10, 100, 100, 100)
...
; userフォルダを通さない設定
tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(20, 26, 430, 410, 390)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(23, 30, 490, 460, 430)
tmpNumStartY := cen_anyOfNumFromDpiAndFontSize(2, 4, 50, 50, 50)
...
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(9, 12, 180, 180, 180)
Gui, 86:Add, Edit,      x+10  yp+0 w%tmpNumW2%  vEdit86_6

tmpNumGroupW := cen_anyOfNumFromDpiAndFontSize(22, 27, 380, 360, 340)
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(15, 15, 210, 200, 190)
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(6, 8, 100, 90, 80)
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(16, 20, 310, 310, 310)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(9, 13, 180, 180, 180)
guf_guiFontFromSizeAndName(fontNum2, "", 86)
Gui, 86:Add, Button,     xp+80 y+5 w%tmpNumW% gSubButton86_6, 元のフォルダに戻す(&D)
guf_guiFontFromSizeAndName(fontNum, "", 86)

tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(18, 22, 350, 350, 350)
...
tmpNumGroupH := cen_anyOfNumFromDpiAndFontSize(8, 13, 180, 180, 180)
;tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(6, 8, 80, 90, 100)
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(1, 4, 60, 60, 60)
Gui, 86:Add, GroupBox, X10 y+5  w%tmpNumGroupW% h%tmpNumGroupH%
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(11, 16, 150, 140, 130)
tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(6, 10, 140, 130, 120)
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(4, 7, 60, 60, 60)
; タイマー
...
fontNum := cen_fontNumFromDpiAndFontSize( 10, 9, 8 )
tmpNumW := cen_anyOfNumFromDpiAndFontSize(8, 10, 80, 80, 80)
; シャットダウンの
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(27, 33, 520, 470, 420)
tmpNumH := cen_anyOfNumFromDpiAndFontSize(36, 36, 550, 490, 430)

tmpNumW2 := cen_anyOfNumFromDpiAndFontSize(15, 19, 250, 220, 190)
tmpNumW3 := cen_anyOfNumFromDpiAndFontSize(14, 18, 190, 170, 150)

tmpNumR := guaf_anyOfNumFromDpi(20, 18, 16)
tmpNumR2 := guaf_anyOfNumFromDpi(7, 5, 3)

tmpNumStartY := cen_anyOfNumFromDpiAndFontSize(0, 6, 60, 60, 60)
...
tmpNumW := cen_anyOfNumFromDpiAndFontSize(21, 29, 450, 400, 350)
