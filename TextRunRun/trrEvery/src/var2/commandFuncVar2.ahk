...
cof_syscommandBefore(com1, rightStr, pOut, GuiNum) {
	if (com1 == "&newItem") {
		...
		return True
	} else if (com1 == "&hotkeyAllGroundNew") {
		hotitpf_entryAllGroundKeyGuiShow(rightStr)
		return True
	} else if (com1 == "&hotkeyAllGroundEdit") {
		hotitpf_hotkeyAllGroundEdit(rightStr)
		return True
...
cof_sysNotSplit(com1, rightStr, pOut, GuiNum){
	if(com1 == "&readFile" ) {
		...
		return True
	} else if (com1 == "&hotkeyAllGroundDelete") {
		hotitpf_hotkeyAllGroundDelete(rightStr, pOut, GuiNum)
		return True
...
cof_syscommandExecute(com1, com2, com3, com4, com5, com6, com7, pOut, GuiNum) {
	if(com1 == "&pctime" ) {
		...
		return True
	} else if(com1 == "&hotkeyAllGroundNewFromCommand" ) {
